        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post" action="insert_addcar.php" enctype="multipart/form-data">
               ...
               <div class="form-group">
                  <div class="col-sm-2">
                  <input type="submit" class="btn btn-theme" name="add" value="Add">
                  </div>
                </div>
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <tr class="gradeC">
                    ...
                    <td ><a href="edit_addcar.php?eid=<?php echo $row['vehicle_id'];?>"><button class="btn btn-info">Edit</button></a>
...
function confirmDelete(delid){
	if( confirm ("are you sure want to delete?")){
		window.location.href='delete_addcar.php?del_id='+delid+'';
		return true;
	}
}
</script>
