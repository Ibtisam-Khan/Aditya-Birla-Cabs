...
if(isset($_REQUEST['eid'])){
	...
	$sql = mysql_query("select * from tbl_customer where cust_id=$id");
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="form-panel">
            <form class="form-horizontal style-form" method="post" action="update_addcustomer.php">
        <div class="row mt">
          <div class="col-lg-12">
              ...
              <div clas="col-sm-12">
                <div class="col-sm-1">
                  ...
                  <div class="col-sm-3">
                      ...
                      <input type="text" name="mobile"  value="<?php echo $mobile; ?>" required  class="form-control">
                   ...
                   <div class="col-sm-3">
                      ...
                      <input type="text" name="password"  value="<?php echo $password; ?>" required class="form-control">
