                    ...
                    <div class="col-sm-9 col-xs-12 padd-lr0">
                        <div class="wheel-top-menu clearfix">
                            <div class="wheel-top-menu-info">
                                <div class="top-menu-item"><a href="#"><i class="fa fa-phone"></i><span>
                          (+91) 9148505597</span></a></div>
                                <div class="top-menu-item"><a href="royalttcabs24@gmail.com"><i class="fa fa-envelope"></i><span>royalttcabs24@gmail.com </span></a></div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3  col-sm-6  padd-lr0">
                        <div class="wheel-address">
                            ...
                            <ul>
                                <li><span><i class="fa fa-map-marker"></i>#216/54,1 <sup>st</sup>Floor,<br>
                        above Bangarpeth Chats<br>
                        Near Metro Station,<br>
                    Mahalakshmi Layout,Bangalore-86</span> 
                                </li>
                                <li><a href="#"><span><i class="fa fa-phone"></i> (+91) 9148505597</span></a></li>
                                <li><a href="royalttcabs24@gmail.com"><span><i class="fa fa-envelope"></i>royalttcabs24@gmail.com</span></a></li>
                            </ul>
                            <div class="wheel-soc">
