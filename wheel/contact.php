    ...
    <body class="">
                    ...
                    <div class="col-sm-9 col-xs-12 padd-lr0">
                        <div class="wheel-top-menu clearfix">
                            <div class="wheel-top-menu-info">
                                <div class="top-menu-item"><a href="#"><i class="fa fa-phone"></i><span>(+91) 8312472716</span></a></div>
                                <div class="top-menu-item"><a href="#"><i class="fa fa-envelope"></i><span>www.hindalco.adityabirla.com</span></a></div>
                            </div>
                                ...
                                <div class="top-menu-item">
                                    <div class="dropdown wheel-user-ico">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="register.html">Logut</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="wheel-contact-info text-center marg-lg-t150 marg-lg-b50 marg-xs-t50 marg-xs-b50">
                        ...
                        <h4>Address</h4>
                        <span>Nehru nagar<br>opposite village,<br>
                        P.B Road NH4<br>
                        Yamanapur,<br>
                        Belgaum, Karnataka 590010</span>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="wheel-contact-info text-center marg-lg-t150 marg-lg-b50 marg-xs-t50 marg-xs-b50">
                        ...
                        <h4>telePhone</h4>
                        <a href="#"><span>080-23199733</span></a>
                        <h4>Mobile No</h4>
                        <a href="#"><span>(+91) 9148505597</span></a>
                    </div>
                </div>
               <!-- <div class="col-sm-3 col-xs-6">
                    <div class="wheel-contact-info text-center marg-lg-t150 marg-lg-b50 marg-xs-t50 marg-xs-b50">
                        ...
                        <h4>Fax</h4>
                        <a href="#"><span>((+91) 9741154721 </span></a>
                        <a href="#"><span>(+91) 9741154721 </span></a>
                    </div>
                </div>-->
                <div class="col-sm-3 col-xs-6">
                    <div class="wheel-contact-info text-center marg-lg-t150 marg-lg-b50 marg-xs-t50 marg-xs-b50">
                        ...
                        <h4>Email</h4>
             <a href=" www.royalttcabs24@gmail.com "><span> www.hindalco.adityabirla.com</span></a>
       ...
       <!-- <div class="container">
        ...
        <footer class="wheel-footer">
            ...
            <div class="container">
                <div class="row">
                      <!-- <div class="col-md-3  col-sm-6  padd-lr0"></div> -->
                    ...
                    <div class="col-md-3  col-sm-6  padd-lr0">
                        ...
                        Nehru Nagar Opposite Village, <br>P.B Road NH4,<br> Yamanapur, Belgaum, Karnataka 590010</span> 
                                ...
                                <li><a href="#"><span><i class="fa fa-phone"></i> (+91) 8312472716</span></a></li>
                                <li><a href="royalttcabs24@gmail.com"><span><i class="fa fa-envelope"></i> www.hindalco.com </span></a></li>
                            </ul>
                            <div class="wheel-soc">
