...
.responsive {
  ...
  height: auto;
          ...
          <form action="booksave1.php" method="post">
            ...
            <div class="container padd-lr0">
                ...
                <div class="col-lg-6 col-lg-pull-6  padd-lr0">
                    <div class="wheel-start-form">
                        <?php session_start();
                        ?>
                       <input type="hidden" id='' name="firstname2" value='<?php echo $_SESSION['firstname'];?>' required>
                        <input type="hidden" id='' name="lastname2" value='<?php echo $_SESSION['lastname'];?>' required>
                         <input type="hidden" id='' name="emailid2" value='<?php echo $_SESSION['email'];?>' required>
                          <input type="hidden" id='' name="pdate" value='<?php echo $_SESSION['pickdate'];?>' required>
                           <input type="hidden" id='' name="vname" value='<?php echo $_POST['vname'];?>' required>
                     ...
                     <div class="form-group">
                            ...
                            <input type="text" id='am' value='<?php echo $_POST['price'];?>' name="uname">
                        </div> 
                        <div>


                        <div><div><div class="form-group">
                                <strong><label color="blue">Designation</lable></strong><br>
                                    <select name="card_type" id='des' class="input">
