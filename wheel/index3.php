        ...
        <div class="wheel-start">
            ...
            <div class="container padd-lr0">
                <div class="col-lg-6 col-lg-push-6 ">
                   <img src="images/bg2.jpg" width="500" height="500">
                </div>
                <div class="col-lg-6 col-lg-pull-6  padd-lr0">
                   <div id="one_way">
                    <div class="wheel-start-form">

                         <h4 style="color:white">Trip Details</h4>
                        <input type="hidden" id='' name="eid1" value='<?php echo $eid1;?>' required>
                        <input type="hidden" id='' name="packprice1" value='<?php echo $packprice1;?>' required>
                         <div class="form-group">
                            <label>Firstname</lable>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id='' name="first_name1"  placeholder="Enter The First Name" required>
                        </div>

                        
                        <div class="form-group">
                            <label>Lastname</lable>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id='' name="lastname1"  placeholder="Enter The Last Name" required>
                        </div>

                        
                        <div class="form-group">
                            <label>Email Id</lable>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="Email" id='' name="email_id1"  placeholder="Enter The Email Id" required>
                        </div>

                        <div class="form-group">
                            <label>Mobile Number</lable>
                            <input type="tel" id='' name="Phone1" pattern="[0-9]+" minlength="10" maxlength="10"  required>
                        </div>


                            <select name="trip_type1" title="Trip Type" class="form-control" required>
                          ...
                          <br>
                            <div class="form-group">
                                <label>Pickup</lable>
                                <input type="text" id=''name="pickup_loc1" placeholder="ZIP, City, Airport or Address" required>
                            ...
                            <div class="clearfix">
                                <div class="wheel-date">
                                    ...
                                    <input  class="datetimepicker" name="pick_date1" id='input-val13' type="text" value="" required>
                                    </label>
                                </div>
                                <div class="wheel-date ">
                                    <span>Pickup time</span>
                                    <label for="input-val14" class="fa fa-clock-o">
                                    <input class="timepicker" name="pick_time1" id='input-val14' type="text" value="18:00" required>
                                    </label>
                                </div>
                            </div>
