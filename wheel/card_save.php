                ...
                <div class="col-lg-6 col-lg-pull-6  padd-lr0">
                    <div class="wheel-start-form">
                        ...
                        <div class="form-group">
                            <label> We have sent the OTP to Your Email-id</lable>
                        </div>   
                        <form action="sample.php?email_id=<?php echo $_GET['email'] ?>" method="post">
                            <label> Enter OTP</lable>
                            <input type="tel" id='' pattern="[0-9 ]+" name="otp" maxlength="6" placeholder="OTP" required>
                            </label>
