    ...
    <div class="col-md-6">
      <div class="thumbnail">
        <a href="" target="_blank">
          <img src="<?php echo $car_img; ?>" alt="Lights" style="height:300px;">
         ...
         <center><h3 class="pa1"><?php echo $vehicle_name; ?></h3>
            ...
            <h5> <?php echo  $no_of_seats; ?> seats</h5>
          </div>  
    <a href="customer_detail2.php?vid=<?php echo $vehicle_id;?>&packprice1=<?php echo $packprice1;?>&vname=<?php echo $vehicle_name;?>">
                         <button class="show" style="background:#00C851;color:white">Get This Cab</button>
