...
.responsive {
  ...
  height: auto;
    ...
    ?>
          ...
          <h1 class="container padd-lr0" style="color:darkblack"><strong>We have sent the details about your booking to <?php echo $eid ?> Email Address </strong> </h1>  
        </div>
         </div>
                    ...
                    <div class="col-md-3  col-sm-6  padd-lr0">
                        <div class="wheel-address">
                            ...
                            <ul>
                                ...
                                <li><a href="#"><span><i class="fa fa-envelope"></i>www.hindalco.com</span></a></li>
                            </ul>
                            <div class="wheel-soc">
