  ...
  <!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	  ...
	  <!-- Social Login -->
				  ...
				  <!-- Login Form -->
				  <form action="auth1.php" method="post" id="form-emp" class="form-horizontal">
					  ...
					  <br>
						  <div class="col-xs-12">
							  <div class="input-group">
								  ...
								  <input type="text" name="emp_name" class="form-control input-lg" placeholder="Username" required>
							  </div>
						  </div>
					  </div>
					  <div class="form-group">
						  <div class="col-xs-12">
							  <div class="input-group">
								  ...
								  <input type="password" name="emp_password" class="form-control input-lg" placeholder="Password" required>
							  </div>0
						  </div>
					  </div>
					  <div class="form-group">
				  ...
				  <!-- Register Form -->
  <form action="auth1.php" method="post" id="form-admin" class="form-horizontal">
					  <div class="form-group">
					  <br><br><br>
					  <h3>Dear Employee Please fill the Details</h3>
					  <br>
