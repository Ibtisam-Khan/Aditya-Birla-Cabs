...
<script>
    $(function(){
        $('#nod').change(function(){
            var designation=$('#nod').val();
            var i=$('#pid1').val();
            var total=designation*i;
            $("#pid").val(total);
                ...
                <div class="col-lg-6 col-lg-pull-6  padd-lr0">
                   <div id="one_way">
                    <div class="wheel-start-form">
                      ...
                      $query = mysql_query("select *  from tbl_vehicles where vehicle_id='$_GET[eid]'");
                      ...
                      ?>
                        <div class="form-group">
                            ...
                            <input type="text" id='' name="uname" pattern="[a-zA-Z ]+" value='<?php echo $_SESSION['firstname'];?>'required>
                        </div>

                        <div class="form-group">
                            <label>Last Name</lable>
                            <input type="text" id='' name="uname" pattern="[a-zA-Z ]+"value='<?php echo $_SESSION['lastname'];?>'  required>
                        </div>
                        
                        <div class="form-group">
                            <label>Email Id</lable>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="Email" id='' name="email_id"value='<?php echo $_SESSION['email'];?>'required>
                        </div>

                        <div class="form-group">
                            <label>Mobile Number</lable>
                            <input type="tel" id='' name="Phone" pattern="[0-9]+" minlength="10" maxlength="10" value='<?php echo $_SESSION['phone'];?>' required>
                        </div>

                        <div class="form-group">
                            <label>Trip Type</lable>
                            <input type="text" id='' name="uname" pattern="[a-zA-Z ]+"value='<?php echo $_SESSION['triptype'];?>' required>
                        </div>

                        <div class="form-group">
                            <label>Pickup Location</lable>
                            <input type="text" id='' name="uname" pattern="[a-zA-Z ]+"value='<?php echo $_SESSION['pickup'];?>' required>
                        </div>

                        <div class="form-group">
                            <label>Drop Location</lable>
                            <input type="text" id='' name="uname" pattern="[a-zA-Z ]+" value='<?php echo $_SESSION['drop'];?>' required>
                        </div>

                        
                        <div>
                            <label> Pickup Date </lable><br>
                            Month: Year <input type="text" id='' name="expiry"  value='<?php echo $_SESSION['pickdate'];?>' required>
                        ...
                        <div class="form-group">
                            <label>Number of seats</lable>
                            <input type="number" id='' name="Phone" pattern="[0-9]+" minlength="10" maxlength="10" value='<?php echo $no_of_seat;?>' required>
                        </div>
                         <div class="form-group">
                            <label>Vehicle Name</lable>
                            <input type="text" id='' name="vname" pattern="[a-zA-Z ]+" value='<?php echo $vehicle_name;?>'required>
                         </div>

                        <div class="form-group">
                            <label>Number of days</lable>
                            <input type="number" id='nod' name="days" pattern="[0-9]+" minlength="10" maxlength="10"  required>
                        </div>
                        
                            <input type="hidden" id='pid1' name="uname" value='<?php echo $price;?>' required>
                

                        <div class="form-group">
                            <label>Price</lable>
                            <input type="text" id='pid' name="price"  value='<?php echo $price;?>' required>
                        </div>
                    ...
                    <button value='submit'class="wheel-btn">
                                   Submit
                            </button>
                        </form>
                    <?php }?>
                    ...
                    <!--//////////////////////////-->
                    <!--<div id="two_way">
                                        <div class="wheel-start-form" style="display:none;">
                        <button id="one_way">one way </button>
                    <button id="two way">two way</button>
                         <h4 style="color:white">Select Your Trip</h4>
                            <select name="trip_type" title="Trip Type" class="form-control">
                          ...
                          <br>
                            ...
                            <input type="text" id='input-val12'name="pickup_loc" placeholder="ZIP, City, Airport or Address" >
                            </label>
                            <div class="clearfix">
                                <div class="wheel-date">
                                    <span>Pickup Date</span>
                                    <label for="input-val13" class="fa fa-calendar">
                                    <input  class="datetimepicker" name="pick_date" id='input-val13' type="text" value="29 Apr">
                                    </label>
                                </div>
                                <div class="wheel-date ">
                                    <span>Pickup time</span>
                                    <label for="input-val14" class="fa fa-clock-o">
                                    <input class="timepicker" name="pick_time" id='input-val14' type="text" value="18:00">
                                    </label>
                                </div>
                            </div>
                             <label for="input-val11"><span>Dropping Off</span>
                            <input type="text" id='input-val11' name="drop_loc" placeholder="ZIP, City, Airport or Address" >
                            </label>
                            <div class="clearfix">
                                <div class="wheel-date">
                                    <span>Return Date</span>
                                    <label for="input-val15" class="fa fa-calendar">
                                    <input  class="datetimepicker" name="drop_date" id='input-val15' type="text" value="29 Apr">
                                    </label>
                                </div>
                                <div class="wheel-date">
                            ...
                            <button class="wheel-btn" id="input-val18" onclick="show('royal')" >Search</button>
                        </div>
                    ...
                    <div class="wheel-start-form">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" id='' name="last_name" placeholder="Enter The Last Name" required>
                               ...
                               <div class="form-group">
                            <label>Email Id</lable>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="Email" id='' name="email" placeholder="Enter The Email Id" required>
                           </div>
                            <div class="form-group">
                            <label> Contact No.</lable>
                            
                            <input type="Number" id="phone" name="mobile" maxlength="10" placeholder="Enter The Contact No." pattern="[0]{1}[0-9]{9}"required>
                           </div>
                ...
                <div class="row">
                    <div class="col-md-3  col-sm-6  padd-lr0">
                        <div class="wheel-address">
                            ...
                            <ul>
                                <li><span><i class="fa fa-map-marker"></i>shop no 20<sup></sup>C M C complex,<br>
                                    near sunday market,<br>
                                     Dandeli Karnataka</span>
                                </li>
                        ...
                        <ul>
                           <li><a href="index-2">Home</a></li>
                            ...
                            <li><a href="contact.php">Contact Us</a></li>
                             <li><a href="car-list-3col2.php"> Feedback</a></li>
