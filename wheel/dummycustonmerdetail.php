...
.responsive {
  ...
  height: auto;
          ...
          <form action="card_save.php" method="post">
            ...
            <div class="container padd-lr0">
                ...
                <div class="col-lg-6 col-lg-pull-6  padd-lr0">
                    <div class="wheel-start-form">
                     ...
                     <div class="form-group">
                            <label>Package amount</lable>
                            <input type="text" id='des' name="uname" value=<?php echo $_GET['pprice'];?>>
                        </div> 
                        <div>
                        ...
                        <div class="form-group">
                            <label>Total amount</lable>
                            <input type="readonly" id='des1' name="uname"  placeholder="Amount after discount"  required>
                        </div>
