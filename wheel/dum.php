...
.responsive {
  ...
  height: auto;
    ...
    if(isset($_POST['submit']))
    {
        ...
        $q=mysqli_query($con,"INSERT INTO `card_info` (uname,email_id,card_num,cvv,expiry,card_type) VALUES('$uname','$email_id','$card_num','$cvv','$expiry','$card_type')");
                ...
                <div class="col-lg-6 col-lg-pull-6  padd-lr0">
                    <div class="wheel-start-form">
                        ...
                        <div class="form-group">
                            <label> total package amount</lable>
                            <input type="tel" id='' pattern="[0-9 ]+" name="otp" required>
                            </label>
                        </div>   
                        <form action="sample.php?email_id=<?php echo $email_id ?>" method="post">
                            <label> amount after discount</lable>
                            <input type="tel" id='' pattern="[0-9 ]+" name="otp" required>
                            </label>
                            <label class="promo promo2">
                            <input type="submit" value ="pay" class="wheel-btn">&nbsp;&nbsp;&nbsp;&nbsp;
                            </label>
                        </div> 
                        ...
                        <div>
                         <label  class="promo promo2">
                           <strong>
                            <input type="submit" class="wheel-btn"> 
                           </strong>
                         </label>
                        </div>
                   </form>
                    ...
                    <div class="col-md-3  col-sm-6  padd-lr0">
                        <div class="wheel-address">
                            ...
                            <ul>
                                ...
                                <li><a href="#"><span><i class="fa fa-envelope"></i>www.hamdanInfocom.com</span></a></li>
                            </ul>
                            <div class="wheel-soc">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-sm-6  padd-lr0"><span>&#169;</a> &amp; Developed By
                            <a href="https:https://hamdaninfocom.in/">Hamdan InfoCom Pvt.Ltd.</a></span></div>
