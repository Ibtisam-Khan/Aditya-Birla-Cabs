            ...
            <div id="page-content" class="block remove-margin">
                ...
                <div class="block-header">
                    <div class="header-section">
                        <h1 class="text-center">Welcome to TV6 Pro<br><small>Please Login </small></h1>
                    </div>
                </div>
                <!-- END Login Title -->
                ...
                <li>
                    <h3><a href="emplogin.php"><span></span>Employee Login</a> </h3></li>
                <hr>
                <li><h3><a href="adminlogin.php"><span></span>Administrator Login</a></h3></li>
                <hr>
            </ul>
                        </div>
                    </div>
