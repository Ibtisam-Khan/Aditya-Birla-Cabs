			  ...
			  <div id="page-content" class="block remove-margin">
				  ...
				  <div class="block-header">
					  <div class="header-section">
						  ...
						  <div class="col-xs-6">
							  <button  class="btn btn-lg btn-info btn-block" id="emp-login-btn">As Employee</button>
						  </div>
				  <!-- END Login Title -->
	  <!-- Social Login -->
						  <!-- END Social Login -->
				  ...
				  <!-- Register Form -->
  <form action="admin_auth.php" method="post" id="form-admin" class="form-horizontal">
					  <div class="form-group">
					  <br><br><br>
